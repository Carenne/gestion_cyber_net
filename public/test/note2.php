...
<div class="row align-items-center">
    ...
    <!-- Box pour alerte (vide au départ) -->
    <div id="alertBox" class="col-md-3">
        <!-- Message d'alerte ici -->
    </div>

    <!-- Alerte custom -->
    <div class="col-md-2">
        <div id="customAlert" class="alert alert-danger fw-bold fs-7 d-none mb-0" role="alert">
            Misafidiana service ray, aza hadino ny montant.
        </div>
    </div>
</div>
